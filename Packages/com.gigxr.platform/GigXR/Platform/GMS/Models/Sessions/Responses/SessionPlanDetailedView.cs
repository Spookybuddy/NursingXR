namespace GIGXR.GMS.Models.Sessions.Responses
{
    ...
    // The commented out properties are not applicable to Session Plans but are on the Session model which this shares.
    public class SessionPlanDetailedView
    {
        ...
        public bool GigXrBranded { get; set; }
